...
public class CryptoUtil {
    ...
    /**
     * Encrypt a given plain text using provided transformation
     *
     ...
     * @param plainText The plaintext value to be encrypted and base64
     *                  encoded
     * @return The base64 encoded self-contained cipher text
     * @throws CryptoException On error during encryption
     */
                    ...
                    if (cipherHolder != null) {
                        ...
                        try {
                            if (cipherTextBytes.length == 0) {
                                ...
                                if (log.isDebugEnabled()) {
                                    log.debug("Decryption successful with transformation : " + cipherTransformation);
                                }
                            }
     ...
     *                             If symmetric encryption enabled, cipherTransformation parameter will be ignored
     * @return Decrypted bytes
     * @throws CryptoException On an error during decryption
     */
